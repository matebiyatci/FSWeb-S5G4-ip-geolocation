...
function cardMaker(data) {
  ...
  var konum = document.createElement("p");
  konum.textContent = "Enlem: ".concat(data["enlem"], " Boylam: ").concat(data["boylam"]);
  infoCard.appendChild(konum);
  var sehir = document.createElement("p");
  sehir.textContent = "\u015Eehir: ".concat(data["şehir"]);
  infoCard.appendChild(sehir);
  var saat = document.createElement("p");
  saat.textContent = "Saat Dilimi: ".concat(data["saatdilimi"]);
  infoCard.appendChild(saat);
  var para = document.createElement("p");
  para.textContent = "Para birimi: ".concat(data["parabirimi"]);
  infoCard.appendChild(para);
  var isp = document.createElement("p");
  isp.textContent = "ISP: ".concat(data["isp"]);
